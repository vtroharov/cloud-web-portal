...
const DashboardGraph2 = ({ cat, showLabel, display, valueX, valueY, vms: { vms } }) => {
  ...
  useLayoutEffect(() => {
    ...
    let series = chart2.series.push(new am4charts.ColumnSeries());
      ...
      series.dataFields.valueX = "memory_alloc";
      series.name = "ram";
  ...
  return (
    <div id="chartdiv2" style={{ width: valueX, height: valueY }}></div>
  );
}

DashboardGraph2.propTypes = {
...
export default connect(mapStateToProps, [])(DashboardGraph2);